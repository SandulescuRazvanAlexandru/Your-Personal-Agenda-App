...
public class PersoanaBDAdapter extends ArrayAdapter<PersoanaBD> {

    private Context context;
    private List<PersoanaBD> persoane;
    private LayoutInflater inflater;
    private int resource;
    private static DateConverter converter = new DateConverter();

    public PersoanaBDAdapter(@NonNull Context context, int resource,
                           @NonNull List<PersoanaBD> objects, LayoutInflater inflater) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        PersoanaBD persoana = persoane.get(position);
        if (persoana != null) {
